...
fn test_read() {
    ...
    let network = file_reader.read_file("src/io/csv/test-data/testInput.csv".to_string()).unwrap();
...
fn test_read_empty_input() {
    let mut file_reader = CsvReader::new();
    let net = file_reader.read_file("src/io/csv/test-data/inputEmpty.csv".to_string());
    assert!(net.is_err());
...
fn test_read_bad_task_min() {
    let mut file_reader = CsvReader::new();
    let net = file_reader.read_file("src/io/csv/test-data/inputBadMin.csv".to_string());
    assert!(net.is_err());
...
fn test_read_bad_task_max() {
    let mut file_reader = CsvReader::new();
    let net = file_reader.read_file("src/io/csv/test-data/inputBadMax.csv".to_string());
    assert!(net.is_err());
    assert_eq!(net.err().unwrap().to_string(),
...
fn test_read_wrong_number_of_task_data() {
    let mut file_reader = CsvReader::new();
    let net = file_reader.read_file("src/io/csv/test-data/inputExtraData.csv".to_string());
    assert!(net.is_err());
    assert_eq!(net.err().unwrap().to_string(),
...
fn test_read_wrong_number_of_affinities() {
    let mut file_reader = CsvReader::new();
    let net = file_reader.read_file("src/io/csv/test-data/inputExtraAffinity.csv".to_string());
    assert!(net.is_err());
    assert_eq!(net.err().unwrap().to_string(),
